...
const TRACE_ICON = {
  turn: '🧠', tool: '🔧', subagent: '🤖', compact: '🗜️', self_heal: '🩹', guardrail: '🛡️', a2a: '🕸️', plan_gate: '🗺️', plan_refine: '🛠️'
};
const TRACE_KIND_LABEL = { tool: '工具', memory: '记忆', mcp: 'MCP', subagent: '子智能体', compact: '压缩', turn: '推理', self_heal: '自愈', guardrail: '护栏', a2a: '多智能体', plan_gate: '规划门控', plan_refine: '规划自精炼' };
